<#
.SYNOPSIS
    Simple cmdlet for sending a Slack message.
.DESCRIPTION
    This cmdlet allows you to send a basic Slack by simply invoking it with the '-message' and '-webhook' parameters.
    It's intended to be used directly in other modules/scripts for a cleaner way of invoking a Slack message.
...
.EXAMPLE
    PS C:\> Invoke-SlackNotification -Message 'Foo Bar' -Webhook 'https://hooks.slack.com/my-webhook' -Colour '#FF0000' -Push 'Fizz Buzz'
